...
Bean bean = adao.withdrawalMemberInfo(mbean.getM_id());
%>
...
location.href='MemberDropAction.jsp?m_id=<%=bean.getM_id() %>'
alert('Ok'); }else {alert('Cancele');}">
<input type="button" value="RESTORE"
onclick="if(confirm('Are you sure this id Restore?')){
location.href='MemberRestoreAction.jsp?m_id=<%=bean.getM_id() %>'
alert('Ok'); }else {alert('Cancele');}">
